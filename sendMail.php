...
if ($subject != '' and $msg!='') {
  ...
  $msg = "We have gotten a message: '$msg' from customer: $firstname $lastname. The client was registered as #$user_id from $location location. Please attend https://www.finecomputing.com/consulting/contact_admin.php?user_id=$user_id&reviewer_id=1 to review this request";
